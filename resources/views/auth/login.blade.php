...
<body class="external-page external-alt sb-l-c sb-r-c">
  ...
  <!-- Start: Main -->
  <div id="main" class="animated fadeIn" style="background: #ffffff url('assets/img/condo.png')no-repeat center center fixed;
          ...
          <div class="panel mt30 mb25">
            ...
            <form method="POST" action="{{ url('/login') }}" id="contact" role="form">
              ...
              <div class="panel-body bg-light p25 pb15">
                ...
                <!-- Username Input -->
                <div class="section">
                  <label for="homenumberx" class="field-label text-muted fs18 mb10">Numero de casa</label>
                  <label for="homenumberx" class="field prepend-icon">
                    <input type="text" name="homenumberx" id="homenumberx" class="gui-input" placeholder="Ingrese Usuario" value="{{ old('homenumberx') }}">
                    <input type="hidden" name="homenumber" id="homenumber" value="{{ old('homenumberx') }}">
                  @if ($errors->has('homenumber'))
                      <span class="help-block">
                            <strong>{{ $errors->first('homenumber') }}</strong>
                        </span>
                    @endif
                    <label for="homenumberx" class="field-icon">
                ...
                <div class="checkbox-custom checkbox-primary mb5">
                  <input type="checkbox" id="checkinqulino">
                  <label for="checkinqulino">Inquilino</label>
                </div>
              </div>
  ...
  jQuery(document).ready(function() {
    ...
    $('form#contact').submit(function() {
      if ($('#checkinqulino').is(":checked"))
        $('#homenumber').val($('#homenumberx').val()+"i");
      else
        $('#homenumber').val($('#homenumberx').val());
